...
<?php if(env('EXTENSION_DEVELOPER_MODE') == true): ?>
    <?php echo $__env->make('modal-button',[
        "class" => "btn-secondary",
...
<?php if($updateAvailable): ?>
    <button class="btn btn-warning" onclick=showExtensionUpdates()><?php echo e(__("Güncellemeleri Yükle")); ?></button>
<?php endif; ?>
<div class="float-sm-right">
    <button class="btn btn-success" onclick="window.location.href='<?php echo e(route('market')); ?>'"><i class="fas fa-shopping-cart mr-1"></i><?php echo e(__("Eklenti Mağazası")); ?></button>
    <button data-toggle="tooltip" title="<?php echo e(__('Ayarlar')); ?>" class="btn btn-primary" onclick="openSettingsModal()"><i
...
<div id="extensionUpdatesWrapper">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <button class="btn btn-success" onclick="requestExtensionUpdate()"><?php echo e(__("Şimdi Güncelle")); ?></button>
        </div>
    </div>
...
<script>
    $('#newExtension').find('select[name=template]').val('<?php echo e($templates->default); ?>');
</script>
...
<script>
    $('input[name=ext_count]').val('<?php echo e(getExtensionViewCount()); ?>');
       var extensionUpdates = [];
       function showExtensionUpdates(){
           showSwal('<?php echo e(__("Okunuyor...")); ?>','info');
           request('<?php echo e(route('get_extension_updates')); ?>',new FormData(),function(success){
    ...
    function requestExtensionUpdate(){
        ...
        request("<?php echo e(route('update_extension_auto')); ?>",form, function (success){
            let json = JSON.parse(success);
    ...
    <?php endif; ?>
</script><?php /**PATH /liman/server/resources/views/extension_pages/manager.blade.php ENDPATH**/ ?>