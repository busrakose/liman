<?php $__env->startSection('content'); ?>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a
                        href="<?php echo e(route('settings')); ?>"><?php echo e(__("Sistem Ayarları")); ?></a></li>
            <li class="breadcrumb-item" aria-current="page"><a
                        href="<?php echo e(route('settings')); ?>#extensions"><?php echo e(__("Eklentiler")); ?></a></li>
            <li class="breadcrumb-item active" aria-current="page"><?php echo e($extension["name"]); ?></li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="card-header p-2">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="pill" href="#tab_1" role="tab" aria-selected="true"><?php echo e(__("Genel Ayarlar")); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#tab_2" role="tab" ><?php echo e(__("Eklenti Veritabanı")); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#tab_3" role="tab"><?php echo e(__("Bileşenler")); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#tab_4" role="tab"><?php echo e(__("Fonksiyonlar")); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#tab_5" role="tab"><?php echo e(__("Mail Tagleri")); ?></a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                    ...
                    <div class="tab-pane fade show active" id="tab_1" role="tabpanel">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Eklenti Adı")); ?></label>
                                <input id="extensionName" type="text" class="form-control" value="<?php echo e($extension['name']); ?>" disabled required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Yayınlayan")); ?></label>
                                <input type="text" name="name" class="form-control" value="<?php echo e($extension['publisher']); ?>" disabled required>
                            </div>
                            <div class="col-md-4 mb-3">
                            <label><?php echo e(__("Yazılım Dili")); ?></label>
                                <select name="programmingLanguage" class="form-control" value="<?php echo e($extension['language']); ?>" autocomplete="off" disabled><br>
                                    <option value="php" <?php if($extension["language"] == "php"): ?> selected='true' <?php endif; ?> >PHP 7.3</option>
                                    <option value="python" <?php if($extension["language"] == "python"): ?> selected='true' <?php endif; ?>>Python 3</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Anahtar'ı Zorunlu Kıl")); ?></label>
                                <select id="require_key" class="form-control" autocomplete="off" enabled><br>
                                    <option value="true" <?php if(array_key_exists("require_key",$extension) && $extension["require_key"] == "true"): ?> selected='true' <?php endif; ?> >Evet</option>
                                    <option value="false" <?php if(!array_key_exists("require_key",$extension) || $extension["require_key"] != "true"): ?> selected='true' <?php endif; ?>>Hayır</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Destek Email'i")); ?></label>
                                <input id="support" type="text" name="email" class="form-control" value="<?php echo e($extension["support"]); ?>" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Logo (Font Awesome Ikon)")); ?></label>
                                <input id="icon" type="text" name="icon" class="form-control" value="<?php echo e($extension["icon"]); ?>" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Paket bağımlılıkları")); ?></label>
                                <input id="dependencies" type="text" name="dependencies" class="form-control" value="<?php echo e(array_key_exists("dependencies",$extension) ? $extension["dependencies"] : ""); ?>" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Versiyon")); ?></label>
                                <input id="version" type="text" name="version" class="form-control" value="<?php echo e($extension["version"]); ?>" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Ayar Doğrulama Fonksiyonu/Betiği")); ?></label>
                                <input id="verification" type="text" name="verification" class="form-control" value="<?php echo e(array_key_exists("verification",$extension) ? $extension["verification"] : ""); ?>" required>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Gerekli Minimum Liman Sürüm Kodu")); ?></label>
                                <input id="supportedLiman" type="text" name="icon" class="form-control" value="<?php echo e(array_key_exists("supportedLiman",$extension) ? $extension["supportedLiman"] : getVersionCode()); ?>" required>
                                <small style="cursor:pointer; font-style: italic;" onclick="$('#supportedLiman').val('<?php echo e(getVersionCode()); ?>')"><?php echo e(__("Mevcut Liman Sürüm Kodunu Al")); ?></small>
                            </div>    
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("Servis Adı yada Kontrol Etmek için Port")); ?></label>
                                <input id="service" type="text" name="service" class="form-control" value="<?php echo e($extension["service"]); ?>" required>
                                <small><?php echo e(__("Birden fazla paket yazmak için aralarında boşluk bırakabilirsiniz.")); ?></small>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label><?php echo e(__("SSL Sertifikası Eklenecek Portlar")); ?></label>
                                <input id="sslPorts" type="text" name="service" class="form-control" value="<?php echo e(array_key_exists("sslPorts",$extension) ? $extension["sslPorts"] : ""); ?>" required>
                                <small><?php echo e(__("Birden fazla port yazmak için aralarında virgül bırakabilirsiniz.")); ?></small>
                            </div>
                        </div>    
                       
                        <button class="btn btn-success " onclick="updateExtension('general')"><i class="fas fa-save mr-1"></i><?php echo e(__("Kaydet")); ?></button><br>
                    </div>
    ...
    <script>
        customRequestData["extension_id"] = "<?php echo e(extension()->id); ?>";
        ...
        function updateExtension(type,tableId = null){
            ...
            request('<?php echo e(route('extension_settings_update')); ?>',data,function(){
                showSwal("<?php echo e(__("Başarıyla kaydedildi")); ?>",'success');
                setTimeout(function(){
                    location.reload();
                },1500);
            }, function(response){
        ...
        function getFunctionParameters(function_name){
            ...
            request('<?php echo e(route('extension_function_parameters')); ?>',data,function(response){
                Swal.close();
        ...
        function deleteFunctionParameters(row){
            Swal.fire({
                ...
                text: "<?php echo e(__('Parametreyi silmek istediğinizden emin misiniz?')); ?>",
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                cancelButtonText: "<?php echo e(__('İptal')); ?>",
                confirmButtonText: "<?php echo e(__('Sil')); ?>"
            }).then((result) => {
                if (result.value) {
                    showSwal('<?php echo e(__("Yükleniyor...")); ?>','info');
                    ...
                    request('<?php echo e(route('extension_remove_function_parameters')); ?>',data,function(response){
                        Swal.close();
                        getFunctionParameters(activeFunction);
                    }, function(response){
                        var error = JSON.parse(response);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /liman/server/resources/views/extension_pages/one.blade.php ENDPATH**/ ?>